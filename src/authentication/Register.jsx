            ...
            .then((result) => {
                ...
                updateProfile(currentUser, {
                    ...
                    .then(async () => {
                        ...
                        await toast.promise(axios.post(`${import.meta.env.VITE_API_URL}/users`, userData), {
                  ...
                  Your password must contain
                                ...
                                <div className="w-full mt-2 flex flex-col items-center gap-[6px]">
                                    {hintList?.map((hint, index) => (
                                        <div
                                            key={index}
                                            className={`text-[14px] flex items-center gap-[8px] font-medium w-fit ${signal[hint.type] ? "text-blue-500" : "text-gray-700"
                                                }`}
                                        >
                                            {signal[hint.type] ? (
