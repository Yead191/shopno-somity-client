                    ...
                    user?.email ?
                        <div className="flex items-center gap-[10px] cursor-pointer relative"
                            ...
                            <div className="relative">
                                <img
                                    src={user?.photoURL || "https://img.freepik.com/free-photo/portrait-man-laughing_23-2148859448.jpg?t=st=1724605498~exp=1724609098~hmac=7f6fc106bae2c17b0c93af1b2e5483d9d8368f3e51284aaec7c7d50590d2bae5&w=740"}
                            ...
                            <h1 className="text-[1rem] font-[400] text-gray-600 sm:block hidden">{user?.displayName}</h1>
